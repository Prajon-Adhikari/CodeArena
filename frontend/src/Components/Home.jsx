    ...
    <div className="min-h-screen  bg-gray-50">
      ...
      <nav className="px-22 flex items-center justify-between py-4 bg-white shadow">
        <div className="flex items-center space-x-6">
          ...
          <a href="#" className="text-sm text-gray-700 hover:underline">Join a hackathon</a>
          <a href="#" className="text-sm text-gray-700 hover:underline">Host a hackathon</a>
          <a href="#" className="text-sm text-gray-700 hover:underline">Resources</a>
        </div>
