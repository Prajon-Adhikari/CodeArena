...
export default function HostHackathon() {
  return (
    <div className="relative">
      {/* Hero Section */}
      <div
        className="relative h-[750px] pt-28 bg-cover bg-center text-white"
        style={{ backgroundImage: `url(${bgImage})` }}
      >
        <div className="absolute inset-0 bg-black opacity-80 z-0"></div>
        <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 pt-[180px]">
      ...
      {/* Features Section */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 my-20 px-6 md:px-20">
        {["Best Quality", "Fast Delivery", "Best Price"].map((title, idx) => (
          <div
            key={idx}
            className="rounded-lg p-8 shadow-md bg-[#D69ADE] hover:bg-gradient-to-r from-[#D69ADE] to-[#AA60C8] transition-all text-black hover:text-white"
          >
            <div className="text-3xl md:text-5xl mb-4 font-bold">0{idx + 1}</div>
